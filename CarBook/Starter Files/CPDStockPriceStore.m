...
- (NSArray *)monthlyAaplPrices
{
    ...
    {
        prices = [NSArray arrayWithObjects:
                  [NSDecimalNumber numberWithFloat:18.63],
                  [NSDecimalNumber numberWithFloat:29.32],
                  [NSDecimalNumber numberWithFloat:24.31],
                  [NSDecimalNumber numberWithFloat:33.68],
                  [NSDecimalNumber numberWithFloat:36.23],
                  [NSDecimalNumber numberWithFloat:28.44],
                  [NSDecimalNumber numberWithFloat:26.20],
                  [NSDecimalNumber numberWithFloat:22.77],
                  [NSDecimalNumber numberWithFloat:05.23],
                  [NSDecimalNumber numberWithFloat:80.13],
                  [NSDecimalNumber numberWithFloat:09.70],
                  [NSDecimalNumber numberWithFloat:08.34],
                  [NSDecimalNumber numberWithFloat:87.44],
                  [NSDecimalNumber numberWithFloat:72.98],
                  [NSDecimalNumber numberWithFloat:71.70],
                  [NSDecimalNumber numberWithFloat:60.28],
                  [NSDecimalNumber numberWithFloat:10.00],
                  [NSDecimalNumber numberWithFloat:07.70],
                  [NSDecimalNumber numberWithFloat:03.00],
                  [NSDecimalNumber numberWithFloat:83.98],                  
                  nil];
    }
    return prices;
}
